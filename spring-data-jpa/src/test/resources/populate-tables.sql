...
('Barista Pro', 199.99, 'Compact and fast single-serve coffee maker.', NULL, 'SINGLE_SERVE', 25, 1),
...
('ColdBrew Wizard', 149.99, 'Cold brew coffee maker with a built-in filter.', NULL, 'COLD_BREW', 10, 1),
('FrenchMaster', 59.99, 'Elegant French press with a durable glass carafe.', NULL, 'FRENCH_PRESS', 40, 1),
('Moka Prestige', 39.99, 'Classic Italian-style moka pot for stovetop brewing.', NULL, 'MOKA', 30, 1),
('PourOver Pro', 74.99, 'Advanced pour-over coffee dripper with a stand.', NULL, 'POUR_OVER', 25, 1);
